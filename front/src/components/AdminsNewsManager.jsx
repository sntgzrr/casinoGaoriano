...
import { updateNew } from "../utils/services/newsServices";
...
const saveNew = async (newId, newData) => {
    try {
        await updateNew(newId, newData).then((updatedNew) => {
            if (newId) {
...
const handleSaveNews = () => {
    ...
    if (editingNews) {
        saveNew(editingNews.id, formData);
        // toast.success("Noticia actualizada exitosamente");
    } else {
        saveNew(null, formData);
