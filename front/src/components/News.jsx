                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gradient-to-br from-amber-900/20 to-amber-950/20 rounded-xl p-8 border border-amber-900/30">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-amber-400 mb-2">Calendario de Eventos</h3>
                                <p className="text-gray-300">
                                    Consulta el calendario completo de eventos del mes en recepción o descarga la app
                                    móvil del Casino Militar para recibir notificaciones de todas las actividades.
                                </p>
                            </div>
                        </div>
                    </div>
