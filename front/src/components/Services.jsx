            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div>
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:grid-rows-3 auto-rows-[20rem] md:auto-rows-auto">
                        <div onClick={() => navigate('/barTomo')} className="bg-blue-500 md:row-span-4 md:row-span-27 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/barTomoImages/barTomo1.avif')] bg-cover bg-contain bg-no-repeat">
                        ...
                        <div onClick={() => navigate('/piscina')} className="bg-blue-500 md:col-span-1 md:row-span-12 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/piscinaImages/piscina1.avif')] bg-cover bg-contain bg-no-repeat">
                        ...
                        <div onClick={() => navigate('/caraCara')} className="bg-blue-500 md:col-span-1 md:row-span-12 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/caraCaraImages/caraCara1.avif')] bg-cover bg-contain bg-no-repeat">
                        ...
                        <div onClick={() => navigate('/casinos')} className="bg-blue-500 md:col-span-2 md:row-span-15 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/casinoImages/casino1.avif')] bg-cover bg-contain bg-no-repeat">
                        ...
                        <div onClick={() => navigate('/mall')} className="bg-blue-500 md:col-span-1 md:row-span-25 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/mallImages/mall1.avif')] bg-cover bg-contain bg-no-repeat">
                        ...
                        <div onClick={() => navigate('/barArpia')} className="bg-blue-500 md:col-span-1 md:row-span-25 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/barArpiaImages/barArpia1.avif')] bg-cover bg-contain bg-no-repeat">
                        ...
                        <div onClick={() => navigate('/barSkyline')} className="bg-blue-500 md:col-span-1 md:row-span-25 rounded-lg cursor-pointer transition-all duration-300 hover:scale-105 relative overflow-hidden bg-[url('../assets/barSkylineImages/barSkyline1.avif')] bg-cover bg-contain bg-no-repeat">
