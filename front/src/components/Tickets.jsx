import { Ticket, Calendar, CheckCircle, X, Download, QrCode, Shield } from "lucide-react";
        ...
        <>
            ...
            {expandedQR && (
                ...
                >
                    ...
                    <div
                        className="relative bg-gray-900 border border-amber-500/50 rounded-2xl p-8 flex flex-col items-center gap-4 shadow-2xl"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="flex items-center gap-2 mb-2">
                            <QrCode className="text-amber-400" size={22} />
                            <span className="text-amber-400 font-bold text-lg">Escanear Ticket</span>
                        </div>
                        ...
                        <p className="text-gray-400 text-sm text-center max-w-xs">
                            Presenta este código al personal del Casino para validar tu acceso
                        </p>
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-green-500/15 border border-green-500/30 rounded-full">
                            <Shield size={14} className="text-green-400" />
                            <span className="text-green-400 text-xs font-semibold">Ticket verificable</span>
                        </div>
                        <button
                            onClick={() => setExpandedQR(null)}
                            className="mt-2 px-6 py-2 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-colors text-sm"
                        >
                            Cerrar
                        </button>
                    </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="border-t border-gray-700 pt-4 flex items-center gap-4">
                                                {/* Small QR preview */}
                                                <button
                                                    onClick={() => setExpandedQR(qrPayload)}
                                                    className="flex-shrink-0 bg-white p-2 rounded-lg hover:scale-105 transition-transform cursor-pointer shadow-md group relative"
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="text-amber-400 font-mono text-xs mb-1">#{ticketCode}</div>
                                                    <button
                                                        onClick={() => setExpandedQR(qrPayload)}
                                                        className="text-gray-500 text-xs hover:text-amber-400 transition-colors underline underline-offset-2"
                                                    >
